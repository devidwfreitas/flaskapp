...
#path /hoteis?cidade=São Paulo&estrelas_min=4&diaria_max=400
...
class Hotel(Resource):
	...
	atributos.add_argument('site_id', type=int, required=True, help="Every hotel must be linked to a site")
	...
	def post(self, hotel_id):
		...
		if not SiteModel.find_by_id(dados.get('site_id')):
			return {'messagem' : 'Hotel must be associated to a valid site id.'}, 400
		try:
			hotel.save_hotel()
		except:
